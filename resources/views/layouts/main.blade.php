...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://checkoutshopper-test.adyen.com/checkoutshopper/sdk/4.9.0/adyen.css">
  ...
  <body>
    ...
    <script src="https://checkoutshopper-test.adyen.com/checkoutshopper/sdk/4.9.0/adyen.js"></script>
