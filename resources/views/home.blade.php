      ...
      <div class="card">
        <div class="card-body">
          <div class="btn-group-vertical w-100">
            ...
            <button type="button" class="btn btn-primary bkg-brand-color-one bdr-brand-color-two mt-2"><a class="txt-brand-color-two" href="/standard-ecom">ECOM / POS</a></button>
