			...
			<div class="row">
									...
									<div class="card" style="width: auto;">
											<label for="valueUpdate"><b>Amount to charge</b> (required)</label>
													<input type="number" name="valueUpdate" id="valueUpdate"  placeholder="100.00" ></br>
														<label for="bookingReference"><b>Reference</b> <p> -PSP for charge/capture</p><p> -StoredPaymentMethodID for recurring</p></label>
															<input type="text" name="bookingReference" id="bookingReference"  placeholder="81000000000000"></br>
															<label for="shopperReference"><b>Shopper Reference</b> (required for Recurring)</label>
																<input type="text" name="shopperReference" id="shopperReference"  placeholder="test@email.com"></br>
					...
					<div class="col-md-3 offset-md-1 col-sm-12"></br>
						<h2><a style="width: 100%; color: black;" data-toggle="collapse" href="#selectCard">Saved Cards</a></h2>
								<div class="collapse" id="selectCard">

									<div class="col-auto">
											<img src="https://help.getjobber.com/hc/article_attachments/360050193133/Screen_Shot_2019-10-29_at_11.45.46_AM.png" class="img-fluid" alt="">
									</div>

								</div></br></br>
							<h2><a style="width: 100%; color: black;" data-toggle="collapse" href="#functions">Other Functions</a></h2>
