                    ...
                    <form action="/create-demo" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" id="configFileLabel" for="configFile">Choose
                                    file</label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="merchantLogoUrl" id="merchantLogoUrl"
                                       aria-describedby="merchantLogoUrlHelp" placeholder="Enter Merchant Logo URL"
                                       value={{ old('merchantLogoUrl') }}>
                                <small id="merchantLogoUrlHelp" class="form-text text-muted">Put in a URL to the
                                    merchant's logo (google it)</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="brandColorOne">Brand Color #1</label>
                                <input type="text" class="form-control" name="brandColorOne" id="brandColorOne"
                                       aria-describedby="brandColorOneHelp" placeholder="Enter Brand Color #1"
                                       value={{ old('brandColorOne') }}>
                                <small id="brandColorOneHelp" class="form-text text-muted">Hex color or color wheel for
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="brandColorTwo" id="brandColorTwo"
                                       aria-describedby="brandColorTwoHelp" placeholder="Enter Brand Color #2"
                                       value={{ old('brandColorTwo') }}>
                                <small id="brandColorTwoHelp" class="form-text text-muted">Hex color or color wheel for
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" id="checkoutScreenshotLabel"
